package com.learn.jetpackcomposepokedex.pokemonList
...
import com.learn.jetpackcomposepokedex.data.models.PokedoxListEntry
import com.learn.jetpackcomposepokedex.repository.PokemonRepository
import com.learn.jetpackcomposepokedex.util.Resource
import com.learn.jetpackcomposepokedex.util.constants.PAGE_SIZE
...
class PokemonListViewModel @Inject constructor(
    ...
    private var  cachedPokemonList= listOf<PokedoxListEntry>()
    ...
    fun searchPokemonList(query:String){
        ...
        viewModelScope.launch(Dispatchers.Default) {
            ...
            val results=listToSearch.filter { it.pokemonName.contains(query.trim(), ignoreCase =true
